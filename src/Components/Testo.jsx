  ...
  return (
    <section className="min-w-screen min-h-full flex flex-col items-center justify-evenly mb-8">
      <div className="container h-56 w-full flex flex-col justify-center px-4">
        <h1 className="text-5xl md:text-6xl font-semibold py-4">Testimonials</h1>
      ...
      <main className="container border md:mx-auto grid md:grid-cols-3 gap-8 md:justify-items-center py-8 px-5">
